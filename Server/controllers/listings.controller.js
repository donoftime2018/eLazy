...
async function browseAPI(keyword, limit = 0, priceCeil = undefined, priceFloor = undefined, sortPrice=undefined, newCond = false, includeDescription = false)
{
  ...
  async function getItems(req, res)
  {
    ...
    // console.log('Total Pages:', totalPages);
      ...
      try {
          const items = await browseAPI(query, limit, priceCeil, priceFloor, sortPrice, newCond, desc)/// await scrapePages(query, totalPages);
          // console.log(items);
